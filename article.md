...
Cursorの拡張機能として動くため、今までのチャット感覚でプロンプトを投げるだけで手元の環境に直接反映されます。ファイルの作成・編集・コマンド実行まで、普段使っているエディタ上で完結しました。「新しいツールを覚えなきゃ」という感覚がなかったのが良かったです。

**ふたつ目は、曖昧な指示でも能動的に動いてくれる点です。**

大分前に作った個人開発のアプリがあるのですが、「あのアプリの進捗を教えて」と曖昧に伝えたら、ファイルを横断して探し出して状況をまとめてくれました。他のツールでもできるのかもしれませんが、素直に感動しました。
